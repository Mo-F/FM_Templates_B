...
foreach f $bip_files {
  template parse args $comp string $header \
      file $f file src/bip/[$comp name]_[file tail $f]
}

foreach f $bip_external_files {
  template parse args $comp string $header \
      file $f file src/bip/external/[$comp name]_[file tail $f]
}
...
template parse file ../common-ros/portlib.h file src/[$comp name]_portlib.h
